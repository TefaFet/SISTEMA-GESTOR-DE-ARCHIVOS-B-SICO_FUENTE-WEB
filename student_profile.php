...
<body>
	...
	<div class="col-md-4">
		...
		?>
		<div class="panel panel-default" style="background-color:#0E8197;" id="panel-margin">
			<div class="panel-heading" style="background-color:#0E8197;">
				<center>
					<h1 class="panel-title" style="color:red;">Perfil del Estudiante</h1>
				</center>
			</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<h4 class="text-danger">¿Estás seguro de que quieres cerrar sesión?</h4>
					</center>
				</div>
